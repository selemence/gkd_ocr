...
class RsaUtil(object):
    ...
    def __init__(self,
        ...
        if company_pri_file:
            with open(company_pri_file, 'rb') as key_file:
                private_key_data = key_file.read()
            self.company_private_key = serialization.load_pem_private_key(private_key_data,
            password=None,
    ...
    def decrypt_by_private_key(self, data):
        private_key = self.company_private_key
